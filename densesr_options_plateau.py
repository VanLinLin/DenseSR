...
class Options():
    ...
    def init(self, parser):
        # global settings
        parser.add_argument('--batch_size', type=int, default=9, help='batch size')  # 24 for vallina omnisr, 15 for omnisrfreq, 10 for large scale omnisrfreq
        parser.add_argument('--nepoch', type=int, default=3200, help='training epochs')
        ...
        parser.add_argument('--pretrain_weights', type=str, default='/ssd7/van/OmniSR/NTIRE_log/ShadowFormerFreqDebug2025-03-07T21:15/models/model_best.pth',help='path of pretrained_weights')
        parser.add_argument('--optimizer', type=str, default='adamw', help='optimizer for training')
        parser.add_argument('--lr_initial', type=float, default=0.0002, help='initial learning rate')
        parser.add_argument('--lr_initial_l2', type=float, default=1e-5, help='initial learning rate')
        ...
        parser.add_argument('--save_dir', type=str, default='./NTIRE_log_all_data_plateau', help='save dir')
        ...
        parser.add_argument('--train_dir', type=str, default='/ssd7/van/OmniSR/datasets/NTIRE_25_shadow/all_train_data', help='dir of train data')
        parser.add_argument('--val_dir', type=str, default='/ssd7/van/OmniSR/datasets/NTIRE_25_shadow/all_valid_data', help='dir of val data')
